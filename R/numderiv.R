...
numderiv <- function(data, cov_x_hat, d, p, n, family) {
  ...
  func <- function(x, d, marg_num, p, n, data, family) {
    ...
    ell_ij_hat <- latent_var_link_numderiv(d, n, param_hat, family)
  ...
  jacob <- jacobian(func, x, d = d, marg_num = marg_num, p = p, n = n, data = data, family = family)
